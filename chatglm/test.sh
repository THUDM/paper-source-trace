...
CUDA_VISIBLE_DEVICES=5 python3 test.py \
    --do_predict \
    --test_file /data/caokun/huge_model/chatGLM/ChatGLM-6B-main/ptuning/data2/test.json \
    --prompt_column content \
    --response_column summary \
    --overwrite_cache \
    --model_name_or_path /data/caokun/huge_model/chatGLM/model/ \
    --output_dir /data/caokun/huge_model/chatGLM/ChatGLM-6B-main/ptuning/output/test/v2/1000/ \
