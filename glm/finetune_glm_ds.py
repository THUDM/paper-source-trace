...
def finetune_ds(model_name="THUDM/glm-2b"):
    ...
    log_path = "glm/log/" + exp_name + ".log"
    os.makedirs("glm/log", exist_ok=True)
    ...
    for epoch in range(args.epochs):
        ...
        torch.save(ds_engine_infer.module, os.path.join(out_dir, "{}-epoch-{}.pt".format("glm-2b", epoch)))


if __name__ == "__main__":
    model_name = "THUDM/glm-2b"
    # model_name = "/home/zhangfanjin/.cache/huggingface/hub/models--THUDM--glm-10b/snapshots/696788d4f82ac96b90823555f547d1e754839ff4"
    # model_name = "/home/zhangfanjin/.cache/huggingface/hub/models--THUDM--glm-2b/snapshots/774fda883d7ad028b8effc3c65afec510fce9634"
